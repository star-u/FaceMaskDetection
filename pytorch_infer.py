...
def inference(image,
    ...
    savepath = "save_images_2/"
    cv2.imwrite(savepath + str(name)+".jpg", image)
    return output_info
...
if __name__ == "__main__":
    ...
    for i in range(1,3007):
    # i = 3006
        img = cv2.imread(r"images\1 ("+str(i)+").jpg")
        img = cv2.cvtColor(img, cv2.COLOR_BGR2RGB)
        inference(img, show_result=False, target_shape=(360, 360), name = i)